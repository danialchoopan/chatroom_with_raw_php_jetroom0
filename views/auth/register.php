...
<div class="flex items-center justify-center h-full">
    <div class="bg-gray-800 p-8 rounded shadow-lg w-96">
        <h2 class="text-2xl font-bold mb-6 text-center text-white">ثبت‌نام کاربر جدید</h2>
        ...
        <form action="/register" method="POST" class="flex flex-col gap-4">
            ...
            <button type="submit" class="bg-indigo-500 text-white p-2 rounded font-bold hover:bg-indigo-600 transition">عضویت</button>
        </form>

        <p class="mt-4 text-sm text-center">
            قبلاً ثبت‌نام کرده‌اید؟ <a href="/login" class="text-indigo-400">وارد شوید</a>
        </p>
    </div>
</div>
